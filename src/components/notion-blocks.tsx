...
export async function NotionBlocks({ id, className }: Props) {
  ...
  return (
    <div
      className={cn(
        "prose max-w-prose dark:prose-invert prose-a:decoration-2 prose-a:decoration-gray-500 prose-a:hover:decoration-black dark:prose-a:hover:decoration-gray-600 prose-a:transition-colors",
        className
      )}
    >
      {groupedBlocks}
